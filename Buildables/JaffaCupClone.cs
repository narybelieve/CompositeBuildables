...
public static class JaffaCupClone
{
    public static PrefabInfo Info { get; } = PrefabInfo
        .WithTechType("JaffaCupClone", "Jaffa Cup (Clone)", "Clone of standard plant.");
    ...
    public static void Register()
    {
        ...
        CloneTemplate clone = new CloneTemplate(Info, "35056c71-5da7-4e73-be60-3c22c5c9e75c"); // model is stored in object called "land_plant_middle_05_03"
