...
public static class MediumFernPalmClone
{
    public static PrefabInfo Info { get; } = PrefabInfo
        .WithTechType("MediumFernPalmClone", "Medium Fern Palm (Clone)", "Clone of standard plant.");
    ...
    public static void Register()
    {
        ...
        CloneTemplate clone = new CloneTemplate(Info, "1d6d89dd-3e49-48b7-90e4-b521fbc3d36f"); // model is stored in object called "land_plant_middle_03_02"
