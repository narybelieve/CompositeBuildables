...
public static class LanternTreeClone
{
    public static PrefabInfo Info { get; } = PrefabInfo
        .WithTechType("LanternTreeClone", "Lantern Tree (Clone)", "Clone of standard plant.");
    ...
    public static void Register()
    {
        ...
        CloneTemplate clone = new CloneTemplate(Info, "8fa4a413-57fa-47a3-828d-de2255dbce4f"); // model is stored in object called "farming_plant_03"
